  ...
  return (
    ...
    >
      <article className="flex flex-col items-start justify-center w-full max-w-3xl mx-auto mb-16">
        <h1 className="mb-4 text-2xl md:text-4xl font-bold tracking-tight text-black dark:text-white">
          {post.title}
        </h1>
        ...
        <a
          className="flex items-center text-sm text-gray-700 dark:text-gray-300 space-x-1"
